...
function StatCard({ icon: Icon, color, label, value, loading }) {
  return (
    <div className="bg-white dark:bg-white/[0.03] border border-slate-200/60 dark:border-white/10 backdrop-blur-xl rounded-2xl shadow-sm dark:shadow-card p-6 flex flex-col items-center text-center gap-3 hover:border-brand-500/20 transition-all duration-300 group">
      <div
      ...
      {loading ? (
        <div className="space-y-2 w-full flex flex-col items-center">
          <div className="h-8 w-16 bg-slate-200 dark:bg-white/10 rounded-lg animate-pulse" />
...
function ValueCard({ icon: Icon, color, title, description }) {
  return (
    <div className="bg-white dark:bg-white/[0.03] border border-slate-200/60 dark:border-white/10 backdrop-blur-xl rounded-2xl shadow-sm dark:shadow-card p-7 flex flex-col gap-4 hover:border-brand-500/30 transition-all duration-300 group">
      <div
        className={`w-12 h-12 rounded-2xl flex items-center justify-center ${color} group-hover:scale-110 transition-transform duration-300`}
      >
        <Icon className="w-6 h-6 text-white" />
...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-surface-900 text-slate-900 dark:text-slate-100">
      ...
      {/* ── Stats ── */}
      <section className="py-16 px-4 border-y border-slate-100 dark:border-white/5">
      ...
      <section className="py-24 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Mission */}
            <div className="bg-white dark:bg-white/[0.03] border border-slate-200/60 dark:border-white/10 backdrop-blur-xl rounded-2xl shadow-sm dark:shadow-card p-8 sm:p-10 relative overflow-hidden">
              <div
      ...
      <section className="pb-24 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <div className="bg-white dark:bg-white/[0.03] border border-slate-200/60 dark:border-white/10 backdrop-blur-xl rounded-2xl shadow-lg dark:shadow-card p-10 sm:p-12 relative overflow-hidden border-brand-500/20">
            <div
              className="absolute inset-0 pointer-events-none"
              style={{
                background:
